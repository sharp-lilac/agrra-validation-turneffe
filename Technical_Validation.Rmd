...
Let's do a Kruskal-Wallis to investigate further. 


```{r kruskal, fig.height=4, fig.width=10}
# Conduct Kruskal-Wallis ---------------------------------------------------------------
...
Running a post-hoc Dunn helps us understand specific Collector pairs that differ. 
Let’s display all Collector pairs that differ significantly. 
We can show whether these Collectors are from within the same Protocols, 
or from different Protocols.


```{r dunn, fig.height=4, fig.width=10, include=FALSE}
# Conduct Dunn test ---------------------------------------------------------------
dunn <- dunn.test(pca_data_metadata_supplemented_filtered$PC1,
  g = pca_data_metadata_supplemented_filtered$Collector,
  method = "bonferroni"
)
dunn2 <- dunn.test(pca_data_metadata_supplemented_filtered$PC2,
  g = pca_data_metadata_supplemented_filtered$Collector,
  method = "bonferroni"
)
```
...
```{r dunn_comparisons,  fig.height=4, fig.width=10}
# Run Dunn comparisons ---------------------------------------------------------------
...
dunn2_df <- filter(dunn2, `dunn2.P.adjusted` < 0.05) %>%
  mutate(
